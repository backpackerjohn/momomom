...
import { ChunkCard, ReplanDiffModal, ImStuckModal } from './ui';
import { FinishLinePanel } from './ui/FinishLinePanel';
    ...
    <>
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-text-on-light-primary tracking-tight">
            Your Momentum Map for:
          </h1>
          <p className="mt-4 text-2xl sm:text-3xl text-accent-text font-semibold max-w-3xl mx-auto">
            "{goal}"
          </p>
        </div>
